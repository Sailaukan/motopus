    ...
    `}
                ...
                `}>
                    {/* <div className="flex items-center space-x-2 mb-4 mt-2">
                        ...
                        <button className="p-3 bg-purple-500 rounded-lg hover:bg-purple-600 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="16"
                                height="16"
                    ...
                    <div className="relative rounded-lg py-0 lg:p-2 my-0 bg-purple-100 lg:my-5">
                    ...
                    <div className="mt-4">
                        <div className="w-full rounded-lg border overflow-x-auto">
                            <div className="flex space-x-2 p-2 w-max">
                                <div className="relative p-3 w-32 lg:w-36 h-20 bg-gray-100 rounded-md hover:bg-gray-200 hover:scale-105 transition transform duration-200 ease-in-out cursor-pointer flex-shrink-0">
                                    <span className="absolute bottom-0 left-0 px-2 py-1 m-1 text-xs bg-black bg-opacity-50 text-white rounded">1</span>
                                </div>
                                <div className="relative p-3 w-32 lg:w-36 h-20 rounded-md cursor-pointer text-gray-400 border-gray-200 border-2 hover:scale-105 transition transform duration-200 flex items-center justify-center flex-shrink-0">
